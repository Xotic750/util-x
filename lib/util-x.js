...
(function (globalThis, Math, window, JSON, module, define) {
    ...
    if (false && $.isNativeFunction(forEachFN)) {
        ...
        $.arrayForEach = function (array, fn, thisArg) {
            ...
            actualObject = $.argToObject(array);
            length = clampInteger(object.length, $.POSITIVE_ZERO, $.MAX_UINT32);
            for (index = $.POSITIVE_ZERO; $.lt(index, length); index += 1) {
                if ($.hasProperty(object, index)) {
                    fn.call(thisArg, object[index], index, actualObject);
                }
            }
        };
    }
    ...
    if ($.isNativeFunction(someFN)) {
        ...
        $.arraySome = function (array, fn, thisArg) {
            ...
            val = false;
            for (index = $.POSITIVE_ZERO; $.lt(index, length); index += 1) {
                if ($.hasProperty(object, index) && fn.call(thisArg, object[index], index, actualObject)) {
                    val = true;
                    break;
                }
            }
    ...
    if ($.isNativeFunction(mapFN)) {
        ...
        $.arrayMap = function (array, fn, thisArg) {
            ...
            for (index = $.POSITIVE_ZERO; $.lt(index, length); index += 1) {
                if ($.hasProperty(object, index)) {
                    $.arrayAssign(arr, index, fn.call(thisArg, object[index], index, actualObject));
                }
            }
        ...
        $.arrayFilter = function (array, fn, thisArg) {
            ...
            for (index = $.POSITIVE_ZERO; $.lt(index, length); index += 1) {
                if ($.hasProperty(object, index)) {
                    ...
                    if (fn.call(thisArg, element, index, actualObject)) {
        ...
        $.arrayReduce = function (array, fn, initialValue) {
            ...
            while ($.lt(index, length)) {
                if ($.isTrue($.hasProperty(object, index))) {
                    accumulator = fn.call($.privateUndefined, accumulator, object[index], index, actualObject);
                }
