            ...
            if (utilx.isNull(tempSafariNFE)) {
                tempSafariNFE = function nfeToObjectString(object) {
                    ...
                    if (utilx.isUndefined(object)) {
                        ...
                        val = nullString;
                    } else if (utilx.strictEqual(typeof object, 'function') && utilx.notStrictEqual(toStringFN.call(object), regexpString) && utilx.strictEqual(typeof object.call, 'function') && utilx.strictEqual(typeof object.apply, 'function')) {
                        val = functionString;
