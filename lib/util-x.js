...
(function (globalThis) {
    ...
    function factory() {
        ...
        /**
         * Custom replacer used to stringify messages that are not strings.
         * @private
         * @function
         ...
         * @return {string}
         */
        function customErrorReplacer(key, value) {
            /*jslint unparam: true */
            /*jshint unused: true */
         ...
         * @return {constructor}
         */
        function makeCustomError(name, ErrorConstructor) {
            function CustomError(message, stackStartFunction) {
                var err;

                if (!utilx.isString(message)) {
                    message = utilx.stringTruncate(utilx.jsonStringify(message, customErrorReplacer), 128);
                }
        ...
        utilx.customError = (function () {
            ...
            return function (name, ErrorConstructor) {
                ...
                if (!utilx.isUndefined(ErrorConstructor) &&
                        (utilx.isPrimitive(ErrorConstructor) ||
                         !utilx.isFunction(ErrorConstructor) ||
