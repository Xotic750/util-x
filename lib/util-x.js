...
(function (globalThis, window, module, define, base, Undefined) {
        ...
        */
        ...
        toClass = (function () {
            try {
                ...
                return function (inputArg) {
                    return base.Object.toString.call(inputArg);
                };
            } catch (eClass) {
                return function (inputArg) {
                    var type = typeof inputArg,
        ...
        toObjectFixIndexedAccess = (function () {
            ...
            return function (inputArg) {
                ...
                if (shouldSplitString && toClass(object) === base.classString.string) {
                    for (index = 0, length = toLength(object.length); index < length; index += 1) {
                        object[index] = base.String.charAt.call(object, index);
                    }
                }
    ...
    function toObjectCallFix(inputArg) {
        ...
        if (hasCallBug && returnThis()) {
            type = typeof inputArg;
            if (type !== 'boolean' || type !== 'number' || type !== 'string') {
                inputArg = cObject(inputArg);
            }
        }
     ...
     */
    try {
        testTemp.tsS1 = base.String.Ctr();
        testTemp.tsS2 = base.String.Ctr(Undefined);
        testTemp.tsS3 = base.String.Ctr(null);
    ...
    $.Object.areSameTypeOf = function (a, b) {
        ...
        return typeA === typeB && !iter(arguments, true, 2, arguments.length, false, function (arg) {
            var type = typeof arg;
    ...
    (function (
        ...
        function isFunctionBasic(inputArg) {
            return toClass(inputArg) === classString || isFunctionFallback(inputArg);
    ...
    try {
        ...
        if (testShims ||
                ...
                base.Array.slice.call(testTemp.someArgs).toString() !== ',,1,a,2,b,,' ||
                base.Array.slice.call(testTemp.someArgs, Undefined, Undefined).toString() !== ',,1,a,2,b,,' ||
                base.Array.slice.call(testTemp.someArgs, -1).length !== 1 ||
                base.Array.slice.call(testTemp.someArgs, 0).toString() !== ',,1,a,2,b,,' ||
                base.Array.slice.call(testTemp.someArgs, 3).toString() !== 'a,2,b,,' ||
                base.Array.slice.call(testTemp.someArgs, -1, 4).length ||
                base.Array.slice.call(testTemp.someArgs, 0, 4).toString() !== ',,1,a' ||
                base.Array.slice.call(testTemp.someArgs, 3, 6).toString() !== 'a,2,b') {
        ...
        $.Array.prototype.slice = function () {
            ...
            try {
                section = base.Array.slice.apply(this, arguments);
            } catch (eSliceFB) {
    ...
    */
    ...
    $.Array.join = join = toMethod($.Array.prototype.join);
    ...
    testTemp.pushObj = {};
    if (!testShims &&
            push(testTemp.pushArr, 0) === 1 &&
            testTemp.pushArr[0] === 0 &&
            push(testTemp.pushObj, 0) === 1 &&
    ...
    testTemp.unshiftObj = {};
    if (!testShims &&
            unshift(testTemp.unshiftArr, 0) === 1 &&
            testTemp.unshiftArr[0] === 0 &&
            unshift(testTemp.unshiftObj, 0) === 1 &&
    ...
    testTemp.npcgType = typeof exec(new RegExp('()??'), '')[1];
    correctExecNpcg = testTemp.npcgType === 'undefined';
        ...
        if (isArray(match)) {
            ...
            if (!correctExecNpcg && match.length > 1 && $.Array.contains(match, '')) {
                ...
                replace(strSlice(toString(str), match.index), r2, function () {
                    ...
                    iter(arguments, true, 1, arguments.length - 2, false, function (it, idx) {
                        var type = typeof it;
    ...
    $.String.prototype.replace = (function (
        ...
        replace,
        new RegExp('\\$(?:\\{(\\$+)\\}|(\\d\\d?|[\\s\\S]))', 'g'),
        base.SyntaxError.Ctr
    ));
    ...
    if (!testShims && isNative(base.Object.getPrototypeOf)) {
        ...
        $.Object.getPrototypeOf = getPrototypeOf = function (object) {
            return cObject(checkObjectCoercible(object))[base.str.proto];
        };
    } else {
    ...
    testTemp.fpbFunc = function () {
        return;
    };

    testTemp.fpbFunc.prototype.constructor = testTemp.fpbFunc;
    enumer(testTemp.fpbFunc, false, function (unused, prop) {
        /*jslint unparam: true */
        /*jshint unused: false */
     ...
     */
    if (!testShims && isNative(base.Array.splice) && base.Array.splice([1, 2], 0).length === 2) {
        try {
            if (!base.Array.splice.call([1, 2]).length) {
    ...
    try {
        ...
        $.Object.keys = function (object) {
            ...
            if (!base.Array.canEnumerArgs && isArguments(object)) {
                props = concat(props, slice(object));
            }
    ...
    try {
        (function (
            ...
            if (defineProp({}, 'sentinel', { value: null }) !== null) {
            ...
            // Test string integer
            try {
                if (defineProp([], '1.', { value: null })[1] !== null) {
            ...
            try {
                if (defineProp([], '0', { value: null }) !== null) {
            ...
            if (definePropertyPatch1 || definePropertyPatch2 || definePropertyPatch3) {
                $.Object.defineProperty = function (object, property, descriptor) {
                    ...
                    return defineProp(object, property, descriptor);
                };
            } else {
                $.Object.defineProperty = defineProp;
            }
            ...
            forEach(keys(testTemp.dpObject), function (key) {
                this(testTemp.dpObject, key, notEnumerable);
            ...
            forEach(keys(testTemp.dpArray), function (key) {
                this(testTemp.dpArray, key, notEnumerable);
            }, $.Object.defineProperty);
    ...
    $.Object.deepFreeze = function (object) {
        ...
        forEach($.Object.keys(object), function (propKey) {
    ...
    if (!testShims && isNative(base.Object.isPrototypeOf)) {
        ...
        $.Object.instanceOf = function (object, ctr) {
            ...
            if (type !== 'undefined' &&
                ...
                if (!val) {
                    while (object) {
                        if (cObject(object) === ctr.prototype) {
                            val = true;
                            break;
                        }
    ...
    try {
        ...
        testTemp.created = base.Object.create(ObjectCreateFunc.prototype, {
    ...
    if (!testShims && isNative(base.Date.now)) {
        ...
        $.Date.now = function now() {
            return getTime(new base.Date.Ctr());
        };
    }
    ...
    $.String.prototype.escapeRegex = function () {
        return replace(onlyCoercibleToString(this), base.RegExp.escapeThese, '\\$&');
    };
    ...
    $.Object.deepEqual = function (a, b) {
        ...
        if (isArguments(a)) {
            ...
            return $.Object.deepEqual(slice(a), slice(b));
        }
        ...
        if (ka.length !== kb.length) {
            ...
            $.Array.stableSort(ka);
            $.Array.stableSort(kb);
            iter(ka, false, 0, ka.length, false, function (it, idx) {
                status = it !== this[idx];
        ...
        iter(ka, false, 0, ka.length, false, function (it) {
            status = !this(a[it], b[it]);
    ...
    $.Object.deepStrictEqual = function (a, b) {
        ...
        if (isArguments(a)) {
            ...
            return $.Object.deepStrictEqual(slice(a), slice(b));
        }
    ...
    if (!testShims && isNative(base.JSON.stringify)) {
        ...
        try {
            testTemp.stringifySupport =
                ...
                // methods entirely.
                base.JSON.stringify(testTemp.customJSON) === '1' &&
                base.JSON.stringify([testTemp.customJSON]) === '[1]' &&
                ...
                //base.JSON.stringify(null, testTemp.customJSON) === '"1"' &&
    ...
    if (!testShims && isNative(base.JSON.parse)) {
        try {
            ...
            if (base.JSON.parse('0') === 0 && base.JSON.parse(false) === false) {
                // Simple parsing test.
                testTemp.parseSimple = base.JSON.parse('{\"A\":[1,true,false,null,\"\\u0000\\b\\n\\f\\r\\t\"]}');
                ...
                if (testTemp.parseSupport) {
                    try {
                        ...
                        testTemp.parseSupport = typeof base.JSON.parse('"\t"') === 'string';
                    } catch (ignore) {}
                    ...
                    if (testTemp.parseSupport) {
                        try {
                            ...
                            testTemp.parseSupport = base.JSON.parse('01') !== 1;
                        } catch (ignore) {}
                    }
                }
            }
        } catch (eParse) {
            testTemp.parseSupport = null;
        }
    }
    ...
    if (testTemp.parseSupport) {
        try {
            ...
            testTemp.parseSupport = $.Object.instanceOf(eParse, base.SyntaxError.Ctr);
        }
    ...
    $.Array.prototype.powerSet = function () {
        var thiObj = toObjectFixIndexedAccess(this),
            object = slice(thiObj),
            lastElement,
            val;
        ...
        if (toLength(object.length) < 1) {
            ...
            val = reduce($.Array.powerSet(object), function (previous, element) {
    ...
    $.Array.prototype.toObject = function () {
        ...
        return reduce(object, function (acc, it, idx) {
            acc[idx] = it;
            acc.length = idx + 1;
    ...
    function factory() {
        ...
        forEach($.Object.keys($), function (key1) {
            ...
            if (this.isPlainObject($[key1])) {
                ...
                forEach(this.keys($[key1]), function (key2) {
                    this.defineProperty(utilx[key1], key2, this.assign({
                        value: $[key1][key2]
                    }, base.properties.notEnumerable));
                    ...
                    if (this.isPlainObject($[key1][key2])) {
                        ...
                        forEach(this.keys($[key1][key2]), function (key3) {
    ...
    enumer(testTemp, true, function (unused, prop) {
        /*jslint unparam: true */
        /*jshint unused : false */
        testTemp[prop] = null;
        delete testTemp[prop];
    });
