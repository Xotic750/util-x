    ...
    function factory() {
        ...
        utilx.customError = (function () {
            ...
            try {
                ...
                throw new CustomSyntaxError('test');
            } catch (e) {
                isOkToUseOtherErrors = utilx.objectInstanceOf(e, SyntaxError);
            }
            ...
            function customError(name, ErrorConstructor) {
                ...
                if (utilx.isFalse(isOkToUseOtherErrors) || utilx.isUndefined(ErrorConstructor)) {
