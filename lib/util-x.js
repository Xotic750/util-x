...
(function (globalThis, window, module, define, base, Undefined) {
    ...
    */
    ...
    $.Array.prototype.forAll = function (fn, thisArg) {
        ...
        throwIfNotAFunction(fn);
        for (val = false, index = 0, length = toLength(object.length); index < length; index += 1) {
    ...
    if (!testShims && isNative(base.Array.findIndex) && !checkV8StrictBug(base.Array.findIndex)) {
        ...
        $.Array.prototype.findIndex = function (fn, thisArg) {
            ...
            throwIfNotAFunction(fn);
            for (val = -1, index = 0, length = toLength(object.length); index < length; index += 1) {
    ...
    try {
        ...
        $.Array.prototype.every = function (fn, thisArg) {
            ...
            throwIfNotAFunction(fn);
            for (val = true, index = 0, length = toLength(object.length); index < length; index += 1) {
                if (index in object) {
                    val = !!fn.call(thisArg, object[index], index, object);
                    if (!val) {
                        break;
    ...
    try {
        ...
        $.Array.prototype.map = function (fn, thisArg) {
            ...
            throwIfNotAFunction(fn);
            for (arr = [], index = 0, arr.length = length = toLength(object.length); index < length; index += 1) {
                if (index in object) {
    ...
    try {
        ...
        (function (
            ...
            $.Array.prototype.reduceRight = function (fn, initialValue) {
                ...
                length = toLength(object.length);
                if (!length && arguments.length === 1) {
                    throw new TypeError(reduceRightTypeErrorMessage);
                }
    ...
    $.Object.forKeys = function (object, fn, thisArg) {
        ...
        throwIfNotAFunction(fn);
        for (keys = $.Object.keys(obj), val = false, index = 0, length = keys.length; index < length; index += 1) {
            it = keys[index];
