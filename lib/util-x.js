...
(function (globalThis, Math, JSON, module, define) {
     ...
     * @memberOf utilx
     * @function
     * @param {string} stringifyToString
     * @param {string} [separator]
     * @param {number} [limit]
     * @return {array.<string>}
     */
    ...
    $.stringSplit = function (stringifyToString, separator, limit) {
        var string = onlyCoercibleToString(stringifyToString),
            output,
            flags,
            lastLastIndex,
            separator2,
        ...
        if ($.isRegExp(separator)) {
            ...
            val = splitFN.call(stringifyToString, separator, limit);
        }
