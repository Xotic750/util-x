/**
 * @file {@link http://xotic750.github.io/astrodate/ AstroDate}. A Javascript utility library..
 * @version 0.0.1
...
(function (globalThis) {
    ...
    function factory() {
        ...
        util.deepEqual = function (a, b) {
            if (util.objectIs(a, b)) {
                return true;
            }

            if (util.isDate(a) && util.isDate(b)) {
                return util.objectIs(a.getTime(), b.getTime());
            }

            if (util.isRegExp(a) && util.isRegExp(b)) {
                return util.objectIs(a.source, b.source) &&
                    util.objectIs(a.global, b.global) &&
                    util.objectIs(a.multiline, b.multiline) &&
                    util.objectIs(a.lastIndex, b.lastIndex) &&
                    util.objectIs(a.ignoreCase, b.ignoreCase) &&
                    util.objectIs(a.sticky, b.sticky);
            }

            if (!util.isTypeObject(a) && !util.isTypeObject(b)) {
                return util.objectIs(a, b);
            }

            if (!util.objectIs(util.objectGetPrototypeOf(a), util.objectGetPrototypeOf(b))) {
                return false;
            }
            ...
            if (util.isArguments(a)) {
                ...
                a = util.argumentsSlice(a);
                b = util.argumentsSlice(b);
            ...
            try {
                ka = util.objectKeys(a);
                kb = util.objectKeys(b);
            } catch (e) {
                return false;
            }
            ...
            status = util.arraySome(ka, function (aKey) {
                return !util.deepEqual(a[aKey], b[aKey]);
            });
