    ...
    */
    ...
    $.Array.prototype.shuffle = function (rounds) {
        ...
        if ('length' in object && !isFunction(object)) {
            ...
            if (isString) {
                for (tempVal = {}, tempVal.length = inLen, inIndex = 0; inIndex < inLen; inIndex += 1) {
    ...
    $.Array.prototype.powerSet = pPowerSet = function () {
        var thisObj = cObject(checkObjectCoercible(this)),
            val = [],
            object,
            lastElement,
            pSet,
        ...
        if ('length' in thisObj && !isFunction(thisObj)) {
            ...
            if (len < 1) {
                ...
                if (toClass(thisObj) === base.classString.string) {
                    for (object = {}, object.length = len, idx = 0; idx < len; idx += 1) {
                        object[idx] = pCharAt.call(thisObj, idx);
                    }
                } else {
