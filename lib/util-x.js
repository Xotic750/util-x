...
(function (globalThis) {
    ...
    function factory() {
        ...
        utilx.arrayPush = (function () {
            // Unused variable for JScript NFE bug
            // http://kangax.github.io/nfe
            var pushFN = baseArray.constructor.prototype.push,
                nfePush;
        ...
        utilx.arrayUnshift = (function () {
            // Unused variable for JScript NFE bug
            // http://kangax.github.io/nfe
            var unshiftFN = baseArray.constructor.prototype.unshift,
                nfeUnshift;
        ...
        utilx.argumentsSlice = function (args, start, end) {
            ...
            if (utilx.isArguments(args) || utilx.isArray(args)) {
                start = utilx.toNumber(start);
                if (utilx.lt(start, 0) || utilx.numberIsNaN(start)) {
                    start = 0;
                }

                end = utilx.toNumber(end);
                if (utilx.lt(end, 0) || utilx.numberIsNaN(end)) {
                    end = args.length;
                }
