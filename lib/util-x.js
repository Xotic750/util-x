...
(function (globalThis, Math, window, JSON, module, define) {
    ...
    if ($.isNativeFunction(forEachFN)) {
        ...
        if ($.isTypeObject(testObject1)) {
            ...
            /*jshint -W098 */
            $.arrayForEach = function (array, fn, thisArg) {
                return forEachFN.apply($.toObjectFixIndexedAccess(array), $.arraySlice(arguments, 1));
            };
            /*jshint +W098 */
        }
    } else {
    ...
    if ($.isNativeFunction(someFN)) {
        ...
        if ($.isTypeObject(testObject1)) {
            ...
            /*jshint -W098 */
            $.arraySome = function (array, fn, thisArg) {
                return someFN.apply($.toObjectFixIndexedAccess(array), $.arraySlice(arguments, 1));
            };
            /*jshint +W098 */
        }
    } else {
    ...
    if ($.isNativeFunction(mapFN)) {
        ...
        if ($.isTypeObject(testObject1)) {
            ...
            /*jshint -W098 */
            $.arrayMap = function (array, fn, thisArg) {
                return mapFN.apply($.toObjectFixIndexedAccess(array), $.arraySlice(arguments, 1));
            };
            /*jshint +W098 */
        }
    } else {
    ...
    if ($.isNativeFunction(filterFN)) {
        ...
        if ($.isTypeObject(testObject1)) {
            ...
            /*jshint -W098 */
            $.arrayFilter = function (array, fn, thisArg) {
                return filterFN.apply($.toObjectFixIndexedAccess(array), $.arraySlice(arguments, 1));
            };
            /*jshint +W098 */
        }
    } else {
    ...
    if ($.isNativeFunction(reduceFN)) {
        ...
        if ($.isTypeObject(testObject1)) {
            ...
            /*jshint -W098 */
            $.arrayReduce = function (array, fn, initialValue) {
                return reduceFN.apply($.toObjectFixIndexedAccess(array), $.arraySlice(arguments, 1));
            };
            /*jshint +W098 */
        }
    } else {
