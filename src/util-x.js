...
(function (globalThis, window, module, define, base, Undefined) {
    ...
    function proxy(fn, thisArg) {
        var args = base.Array.slice.call(arguments, 2);
    ...
    */
    ...
    $.Function.ToMethod = function (protoFn, checkThisArgFn) {
        ...
        if (!$.Function.isFunction(checkThisArgFn)) {
            checkThisArgFn = $.Object.CheckObjectCoercible;
        }
    ...
    $.Number.prototype.modulo = function (divisor) {
        return $.Object.CheckObjectCoercible(this) - divisor * floor(this / divisor);
    };
    ...
    if (!testShims && push([], 0) === 1) {
        ...
        $.Array.prototype.push = function () {
            base.Array.push.apply($.Object.CheckObjectCoercible(this), slice(arguments));
    ...
    if (!testShims && unshift([], 0) === 1) {
        ...
        $.Array.prototype.unshift = function () {
            base.Array.unshift.apply($.Object.CheckObjectCoercible(this), slice(arguments));
    ...
    try {
        ...
        $.Array.prototype.map = function (fn, thisArg) {
            ...
            iter(object, true, 0, arr.length, false, function (it, idx, obj) {
                this(arr, idx, fn.call(thisArg, it, idx, obj));
            }, $.Array.assign);
