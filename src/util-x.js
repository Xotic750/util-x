    ...
    function factory() {
        ...
        utilx.arraySlice = (function () {
            ...
            var sliceFN = baseArray.slice,
                arr = [utilx.privateUndefined, null, 1, 'a', 2, 'b', null, utilx.privateUndefined],
                nfeSlice;
            ...
            /*global console */
            try {
                utilx.strictEqual(sliceFN.call(someArgs()).toString(), arr.slice().toString());
                utilx.strictEqual(sliceFN.call(someArgs(), utilx.privateUndefined, utilx.privateUndefined).toString(),
                                  arr.slice(utilx.privateUndefined, utilx.privateUndefined).toString());
                utilx.strictEqual(sliceFN.call(someArgs(), -1).toString(), arr.slice(-1).toString());
                utilx.strictEqual(sliceFN.call(someArgs(), 0).toString(), arr.slice(0).toString());
                utilx.strictEqual(sliceFN.call(someArgs(), 3).toString(), arr.slice(3).toString());
                utilx.strictEqual(sliceFN.call(someArgs(), -1, 4).toString(), arr.slice(-1, 4).toString());
                utilx.strictEqual(sliceFN.call(someArgs(), 0, 4).toString(), arr.slice(0, 4).toString());
                utilx.strictEqual(sliceFN.call(someArgs(), 3, 6).toString(), arr.slice(3, 6).toString());
            } catch (e) {
        ...
        utilx.deepEqual = function (a, b, opts) {
            ...
            if (utilx.isArguments(a)) {
                ...
                a = utilx.arraySlice(a);
                b = utilx.arraySlice(b);
