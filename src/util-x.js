            ...
            if (utilx.isNull(tempSafariNFE)) {
                tempSafariNFE = function nfeToObjectString(object) {
                    ...
                    if (utilx.isUndefined(object)) {
                        ...
                        val = nullString;
                    } else if (utilx.stricEqual(typeof object, 'function') && utilx.notStrictEqual(toStringFN.call(object), regexpString) && object.call && utilx.strictEqual(typeof object.call, 'function') && object.apply && utilx.strictEqual(typeof object.apply, 'function')) {
                        val = functionString;
