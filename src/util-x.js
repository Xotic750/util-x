...
(function (globalThis, window, module, define, base, Undefined) {
     ...
     * @type {boolean}
     */
    if (!base.Object.hasOwn.call(base.Array.slice.call((function () { return arguments; }(1))), '0')) {
    ...
    if (base.Array.canIterArgs) {
        ...
        base.Array.internalSlice = function (start, end) {
            /*jslint bitwise: true */
            var obj = base.Object.Ctr(checkObjectCoercible(this)),
                length = obj.length >>> 0,
                relativeStart = start >> 0,
                val = [],
                next = 0,
                type = typeof end,
                isArgs = base.Object.toString.call(obj) === base.classString.arguments ||
    ...
    function toMethod(protoFn) {
        return function (thisArg) {
            return protoFn.apply(thisArg, base.Array.internalSlice.call(arguments, 1));
        };
    }
    ...
    var testShims = true,
         ...
         * @returns {Array}
         */
        slice = toMethod(base.Array.internalSlice),
    ...
    */
    ...
    function iter(object, has, start, length, reverse, fn, thisArg) {
        ...
        if (!base.Array.canIterArgs && $.Object.isArguments(object)) {
            has = false;
        }
    ...
    internalSlice = function (start, end) {
        ...
        while (k < finalEnd) {
            if ((!base.Array.canIterArgs && $.Object.isArguments(object)) || $.Object.has(object, k)) {
     ...
     */
    try {
        if (testShims || !base.Array.canIterArgs || !$.Function.isNativeFunction(base.Array.slice) ||
    ...
    if (!testShims && $.Function.isNativeFunction(base.Object.assign)) {
        ...
        $.Object.assign = function (target) {
            ...
            $.Array.forEach(slice(arguments, 1), function (source) {
                this.forEach($.Object.keys($.Object.ToObjectFixIndexedAccess(source)), function (key) {
