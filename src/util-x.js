...
(function (globalThis, window, module, define, base, Undefined) {
    ...
    */
    ...
    $.String.isDigits = $isDigits = toMethod($.String.prototype.isDigits);
    ...
    try {
        (function () {
            ...
            if (mDefineProperty({}, 'sentinel', { value: null }).sentinel !== null) {
            ...
            try {
                ...
                if (testObj.length !== 0 || testObj[1] === null || testObj['1.'] !== null) {
            ...
            try {
                testObj = mDefineProperty([], '1', { value: null });
                if (testObj.length !== 1 || testObj[1] !== null) {
            ...
            try {
                ...
                if (testObj.length !== 2 || testObj[1] !== 20) {
                    ...
                    if (isArray(object) || isArguments(object)) {
                        ...
                        if (toClass(property) === classString && isNumeric(property)) {
                            if (!pHasOwn.call(descriptor, 'get') && !pHasOwn.call(descriptor, 'set')) {
                                if (pHasOwn.call(descriptor, 'value') || !pHasOwn.call(object, property)) {
                                    if (isProtoSupported) {
                                ...
                                if (!isNative(mDefineGetter) || !isNative(mDefineSetter)) {
                                    throw new CTypeError('getters & setters can not be defined' +
            ...
            for (testProp in testTemp.dpArray) {
                if (pHasOwn.call(testTemp.dpArray, testProp)) {
                    $.Object.defineProperty(testTemp.dpArray, testProp, propNotEnumerable);
                }
            }
