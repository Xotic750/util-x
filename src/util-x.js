...
(function (globalThis) {
    ...
    function factory() {
        ...
        utilx.arraySlice = (function () {
            ...
            try {
                utilx.deepEqual(sliceFN.call(someArgs()), arr.slice());
                utilx.deepEqual(sliceFN.call(someArgs(), -1), arr.slice(-1));
                utilx.deepEqual(sliceFN.call(someArgs(), 0), arr.slice(0));
                utilx.deepEqual(sliceFN.call(someArgs(), 3), arr.slice(3));
                utilx.deepEqual(sliceFN.call(someArgs(), -1, 4), arr.slice(-1, 4));
                utilx.deepEqual(sliceFN.call(someArgs(), 0, 4), arr.slice(0, 4));
                utilx.deepEqual(sliceFN.call(someArgs(), 3, 6), arr.slice(3, 6));
            } catch (e) {
