    ...
    var testShims = true,
        ...
        */
        ...
        hasProtoEnumBug = (function () {
            var isEn = base.Object.propertyIsEnumerable.call(returnArgs, 'prototype'),
                Constructor;
            ...
            if (!isEn) {
                ...
                isEn = base.Object.propertyIsEnumerable.call(Constructor, 'prototype');
            }
        ...
        hasBoxedStringBug = (function () {
            ...
            return objg[0] !== 'g' || !base.Object.hasOwn.call(objg, '0');
        }()),
        ...
        hasErrorProps = (function () {
            ...
            for (prop in protoError) {
                if (base.Object.hasOwn.call(protoError, prop)) {
    ...
    */
    ...
    try {
        ...
        $.Object.keys = function (object) {
            ...
            if (hasBoxedStringBug && toClass(object) === classString(object)) {
                for (index = 0, length = object.length; index < length; index += 1) {
