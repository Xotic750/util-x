...
(function (globalThis, window, JSON, module, define, base) {
     ...
     * @const
     */
    base.Undefined = base.Function.instance();
    ...
    /**
     * The proxy() function creates a new function (a bound function) with the same function body
     ...
     * @returns {(boundFunction|undefined)}.
     */
     ...
     * @function
     * @param {*} inputArg
     * @throws {TypeError} if inputArg is {@link null} or {@linkundefined}.
     * @returns {*}
    ...
    if (strictEqual(typeof $.Object.ToClassString, base.str.Undefined)) {
        $.Object.ToClassString = function (inputArg) {
            ...
            } else if (inputArg === base.inputArg.proto) {
                val = base.classString.inputArg;
    ...
    if (!testShims && $.Function.isNativeFunction(base.number.isNaN)) {
        ...
        $.Number.isNaN = $.Function.bind($.Object.is, base.Undefined, $.Number.NaN);
    }
    ...
    /**
     * This method creates a new array of unique occurences (===) ordered as per the original array.
     * If deep is set to true then uses deepStrictEqual instead of ===.
     * @memberof utilx.Array
     * @name unique
     * @function
     * @param {ArrayLike} array
    ...
    $.Array.prototype.unique = function (deep) {
        return $.Array.filter(this, function (element, index) {
            var dontHave = $.Array.indexOf(this, element) === index;

            if (dontHave && deep) {
                dontHave = !$.Array.some(this, function (ele, idx) {
                    return idx < index && $.Object.deepStrictEqual(element, ele);
                });
            }
     ...
     * @function
     * @param {ArrayLike} array
     * @throws {TypeError} if array is {@link null} or {@linkundefined}
