...
(function (globalThis, window, module, define, base, Undefined) {
    ...
    */
     ...
     */
    testValue = null;
    if (isNotPrimitive(window) && isNotPrimitive(window.alert)) {
    ...
    $.Function.isNativeFunction = isNative = function (inputArg) {
        return isNotPrimitive(inputArg) &&
                (isFunction(inputArg) && (isNativeFunction(inputArg) || isIENativeFunction(inputArg)));
    };
    ...
    $.Object.isObject = isObject = function (inputArg) {
        return isNotPrimitive(inputArg) && toClass(inputArg) === base.classString.object && !isFunction(inputArg);
    };
