    ...
    function factory(printStackTrace) {
        ...
        utilx.objectGetPrototypeOf = (function () {
            ...
            if (utilx.isFunction(getPrototypeOfFN)) {
                ...
                testObject = utilx.returnArgs();
                console.log('# FIX OPERA10');
                if (utilx.notStrictEqual(testObject, baseObjectPrototype)) {
                    fixOpera10Arguments =  utilx.strictEqual(testObject.constructor.prototype, baseObjectPrototype) &&
                                    baseObjectPrototype.isPrototypeOf(testObject);
                }
                ...
                tempSafariNFE = function nfeGetPrototypeOf(object) {
                    ...
                    if (utilx.isObject(object[protoName])) {
                        ...
                        if (fixOpera10Arguments && utilx.isArguments(object)) {
                            ctrProto = baseObjectPrototype;
                        } else if (utilx.isFunction(object.constructor)) {
