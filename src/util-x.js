...
(function (globalThis, window, JSON, module, define) {
     ...
     * @return {number}
     */
    if ($.isNativeFunction(findIndexFN)) {
        /*jshint -W098 */
    ...
    if ($.isNativeFunction(fromFN)) {
        ...
        $.arrayFrom = function (arrayLike, mapfn, thisArg) {
            ...
            for (index = 0; index < length; index += 1) {
                value = object[index];
                if (mapping) {
                    value = mapfn.call(thisArg, value, index, object);
                }
    ...
    try {
        ...
        if ($.isNativeFunction(everyFN) && $.isTypeObject(testObject1) &&
                $.strictEqual($.toObjectString(testObject1), className.string)) {
     ...
     * @return {array}
     */
    if ($.isNativeFunction(copyWithinFN)) {
        /*jshint -W098 */
