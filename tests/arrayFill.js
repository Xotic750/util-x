...
(function () {
    ...
    describe('arrayFill', function () {
        it('works without a value', function () {
            ...
            expect(utilx.arrayFill(original)).to.eql(filled);
        });
        ...
        it('works with just a value', function () {
            ...
            expect(utilx.arrayFill(original, -1)).to.eql(filled);
        });
        ...
        it('accepts a positive start index', function () {
            ...
            expect(utilx.arrayFill(original, -1, 1)).to.eql(filled);
        });
        ...
        it('accepts a positive start and end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, 1, 4)).to.eql(filled);
        });
        ...
        it('accepts a positive start and negative end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, 1, -1)).to.eql(filled);
        });
        ...
        it('accepts a positive start and large end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, 1, 42)).to.eql(filled);
        });
        ...
        it('accepts a negative start and large positive end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, -3, 42)).to.eql(filled);
        });
        ...
        it('accepts a negative start and small positive end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, -3, 5)).to.eql(filled);
        });
        ...
        it('accepts a negative start smaller than negative end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, -3, -1)).to.eql(filled);
        });
        ...
        it('accepts a negative start larger than negative end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, -1, -3)).to.eql(filled);
        });
        ...
        it('accepts a undefined start larger and positve end index', function () {
            ...
            expect(utilx.arrayFill(original, -1, utilx.privateUndefined, 4)).to.eql(filled);
        });
        ...
        it('empty range remains unchanged', function () {
            ...
            expect(utilx.arrayFill(original, -1, 0, 0)).to.eql(filled);
        });
        ...
        it('accepts a positive start index', function () {
            ...
            expect(utilx.arrayFill(original, -1, 3)).to.eql(filled);
        });
        ...
        it('accepts a large start index', function () {
            ...
            expect(utilx.arrayFill(original, -1, 9)).to.eql(filled);
        });

        it('should throw a TypeError in each case', function () {
            expect(function () {
                utilx.arrayFill(null);
            }).to.throwException(function (e) {
                expect(e).to.be.a(TypeError);
            });

            expect(function () {
                utilx.arrayFill(utilx.privateUndefined);
            }).to.throwException(function (e) {
                expect(e).to.be.a(TypeError);
            });
        });
