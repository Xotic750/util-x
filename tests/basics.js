...
(function (privateUndefined) {
    ...
    test('basics', function (t) {
        ...
        t.strictEqual(utilx.isEmptyArray([privateUndefined]), false, 'isEmptyArray');
        ...
        t.strictEqual(utilx.isEmptyArray(returnArgs(privateUndefined)), false, 'isEmptyArray');
        ...
        t.strictEqual(utilx.arrayIsArray(utilx.argumentsSlice(returnArgs(privateUndefined))), true, 'argumentsSlice');
        ...
        t.strictEqual(utilx.isPlainObject(privateUndefined), false, 'isPlainObject');
        t.strictEqual(utilx.isPlainObject([]), false, 'isPlainObject');
