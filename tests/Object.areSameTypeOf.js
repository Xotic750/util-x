...
(function () {
    ...
    describe('Object.areSameTypeOf', function () {
        ...
        it('are same typeof in each case', function () {
            ...
            expect(utilx.Object.areSameTypeOf(undefined, undefined,
                                       undefined)).to.be.ok();
            ...
            expect(utilx.Object.areSameTypeOf('1', '2', String())).to.be.ok();
            expect(utilx.Object.areSameTypeOf(true, false, Boolean())).to.be.ok();
            expect(utilx.Object.areSameTypeOf({}, {}, Object())).to.be.ok();
            expect(utilx.Object.areSameTypeOf({}, [], Array())).to.be.ok();
            expect(utilx.Object.areSameTypeOf({}, new Date())).to.be.ok();
        ...
        it('are not same typeof in each case', function () {
            ...
            expect(utilx.Object.areSameTypeOf('1', '2', Boolean())).to.not.be.ok();
